	<h1><a id="title" href="/">${bf.config.blog.name}</a></h1>
	<em>.</em><a href="/">work</a>&nbsp;&nbsp;
    <em>.</em><a href="${bf.util.site_path_helper(bf.config.blog.path)}">blog</a>&nbsp;&nbsp;
	<em>.</em><a href="http://github.com/arturoc">code</a>&nbsp;&nbsp;
